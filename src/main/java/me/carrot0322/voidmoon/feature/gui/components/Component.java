package me.carrot0322.voidmoon.feature.gui.components;
...
import me.carrot0322.voidmoon.feature.gui.components.item.button.Button;
...
public class Component extends Feature {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        VoidMoon.textManager.drawStringWithShadow(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) VoidMoonGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && this.isHovering(mouseX, mouseY)) {
            ...
            VoidMoonGui.getClickGui().getComponents().forEach(component -> {
                if (component.drag) {
